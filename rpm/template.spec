...
%global pkg_name sick_safetyscanners2
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-sick-safetyscanners2
Version:        1.0.5
Release:        1%{?dist}
...
* Wed Apr 29 2026 Lennart Puck <puck@fzi.de> - 1.0.4-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Lennart Puck <puck@fzi.de> - 1.0.4-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Lennart Puck <puck@fzi.de> - 1.0.4-1
- Autogenerated by Bloom
